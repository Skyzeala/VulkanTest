...
- Physical devices, queue Families, and logical devices - find GPUs and check their computing and Vulkan support capabilities, then create an interface to use one
